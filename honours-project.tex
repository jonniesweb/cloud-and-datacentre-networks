...
Cloud computing can be characterized by the five distinct elements that separate it from traditional computing. Those five elements are on-demand self service, broad network access, resource pooling, rapid elasticity, and measured service.
...
\subsection{Deployment Model} \label{sub:deployment-model}
